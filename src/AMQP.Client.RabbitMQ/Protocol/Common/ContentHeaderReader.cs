...
{
    internal class ContentHeaderReader : IMessageReaderAdapter<ContentHeader>
    {
        ...
        public bool TryParseMessage(in ReadOnlySequence<byte> input, out ContentHeader message)
        {
            message = default;
            _bitCount = 0;
