...
namespace AMQP.Client.RabbitMQ.Protocol.Methods.Basic
{
    public static class BasicProtocolExtension
    {
        ...
        public static ValueTask SendBasicConsumeAsync(this RabbitMQProtocolWriter protocol, ushort channelId, ConsumerInfo info, CancellationToken token = default)
        {
            return protocol.WriteAsync(new BasicConsumeWriter(channelId), info, token);
        }
        public static string ReadBasicConsumeOkAsync(this RabbitMQProtocolReader protocol, in ReadOnlySequence<byte> input)
        {
            return protocol.ReadShortStrPayload(input);
        }
        public static ValueTask<DeliverInfo> ReadBasicDeliverAsync(this RabbitMQProtocolReader protocol, CancellationToken token = default)
        {
        ...
        public static IChunkedBodyFrameReader CreateResetableChunkedBodyReader(this RabbitMQProtocolWriter protocol, ushort channelId)
        {
