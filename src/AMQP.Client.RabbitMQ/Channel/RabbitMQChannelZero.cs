namespace AMQP.Client.RabbitMQ.Channel
{
   ...
   internal class RabbitMQChannelZero : IRabbitMQClosable, IRabbitMQOpenable
   {
       ...
       public ServerConf ServerInfo { get; private set; }
       public ClientConf ClientInfo { get; private set; }
       public TuneConf MainInfo { get; private set; }
       ...
       private readonly Protocol.Methods.Connection.RabbitMQConnectionInfo _connectionInfo;
       private Timer _heartbeat;
       private readonly ByteWriter _byteWriter;

       internal RabbitMQChannelZero(RabbitMQConnectionFactoryBuilder1 builder, TaskCompletionSource<CloseInfo> connectionClosedSrc, CancellationToken token)//:base(protocol)
       {
       ...
       private async ValueTask<TuneConf> ProcessTuneMethodAsync()
       {
